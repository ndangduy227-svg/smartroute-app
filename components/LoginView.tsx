...
export const LoginView: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-slate-900 text-slate-100 p-4">
            <div className="mb-8 transform scale-150 text-brand-teal">
            ...
            <div className="bg-slate-800 p-8 rounded-2xl shadow-2xl w-full max-w-md border border-slate-700">
                ...
                <button
                    ...
                    className="w-full bg-white text-slate-900 px-6 py-4 rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-gray-100 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
                >
